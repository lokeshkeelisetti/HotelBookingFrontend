                ...
                <Media>
                    ...
                    {props.isEditing !== room._id ? (
                        <Media body>
                            <Media heading>
                                {room.type.type}
                                <Button className="bg bg-warning ml-4" color="warning" onClick={() => props.handleEdit(room._id)}><span className="fa fa-pencil"></span>Edit</Button>
                                <Button className="bg bg-danger ml-4" color="danger" onClick={() => props.handleDelete(room._id)}><span className="fa fa-trash"></span></Button>
                            </Media>
                            <p>{room.roomNo}</p>
                        ...
                        <Form onSubmit={props.handleEditSubmit}>
                            ...
                            <Button type="submit" className="btn btn-danger" color="danger">Edit</Button>
                            <Button className="btn" onClick={() => props.handleEdit(room._id)}>Cancel</Button>
                        </Form>
                    )
                    }
                </Media>
            ...
            <Container className="mt-5 mb-5">
                ...
                <TabContent activeTab={this.state.activeTab}>
                    <TabPane tabId="1">
                        <Row>
                            <ListGroup>
                                <RenderRooms rooms={this.state.rooms} isEditing={this.state.isEditing} handleDelete={this.handleDelete}
                                 handleEdit = {this.handleEdit} handleEditSubmit={this.handleEditSubmit}/> 
                            </ListGroup>
                        </Row>
                    </TabPane>
                    <TabPane tabId="2">
                        <Row>
                            <Form onSubmit={this.handleAddRoom}>
                                <FormGroup>
                                    ...
                                    <Input type="text" id="roomNo" innerRef={(roomNo) => this.roomNo = roomNo} />
                                </FormGroup>
                                <FormGroup>
                                    <Label htmlFor="roomType">Room Types</Label>
                                    <Input type="select" id="roomType" innerRef={(roomType) => this.roomType = roomType} >
                                        <option selected value="something">Something</option>
                                    </Input>
                                </FormGroup>
                                <Button type="submit" class="bg bg-primary" color="primary">Add Room</Button>
                            </Form>
                        </Row>
                    </TabPane>
                    <TabPane tabId="3">
                        <Row>
                            <Form onSubmit={this.handleAddRoomType}>
                                <FormGroup>
                                    ...
                                    <Input type="text" id="newRoomType" innerRef={(newRoomType) => this.newRoomType = newRoomType} />
                                </FormGroup>
                                <FormGroup>
                                    <Label htmlFor="price">Price for type</Label>
                                    <Input type="text" id="price" innerRef={(price) => this.price = price} />
                                </FormGroup>
                                ...
                                <Button type="submit" color="primary" >Add Room Type</Button>
                            </Form>
                        </Row>
                    </TabPane>
                </TabContent>
